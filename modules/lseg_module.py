...
class LSegModule(LSegmentationModule):
    def __init__(self, data_path, dataset, batch_size, base_lr, max_epochs, **kwargs):
        ...
        train_transform = [
            ...
            mindspore.dataset.vision.Normalize(norm_mean, norm_std),
        ]
        ...
        self.train_transform = mindspore.dataset.transforms.Compose(train_transform)
        self.val_transform = mindspore.dataset.transforms.Compose(val_transform)
