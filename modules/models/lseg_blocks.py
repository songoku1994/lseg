...
def _make_scratch(in_shape, out_shape, groups=1, expand=False):
    ...
    #     groups=groups,
    # )
    scratch.layer1_rn = mindspore.nn.Conv2d(
        in_shape[0],
        out_shape1,
        kernel_size=3,
        stride=1,
    ...
    #     groups=groups,
    # )
    scratch.layer2_rn = mindspore.nn.Conv2d(
        in_shape[1],
        out_shape2,
        kernel_size=3,
        stride=1,
    ...
    #     groups=groups,
    # )
    scratch.layer3_rn = mindspore.nn.Conv2d(
        in_shape[2],
        out_shape3,
        kernel_size=3,
        stride=1,
    ...
    #     groups=groups,
    # )
    scratch.layer4_rn = mindspore.nn.Conv2d(
        in_shape[3],
        out_shape4,
        kernel_size=3,
        stride=1,
...
class Interpolate(mindspore.nn.Cell):
...
class ResidualConvUnit(mindspore.nn.cell):
...
class FeatureFusionBlock(mindspore.nn.cell):
...
class ResidualConvUnit_custom(mindspore.nn.cell):
    """Residual convolution module."""
    ...
    def __init__(self, features, activation, bn):
        ...
        if self.bn == True:
            self.bn1 = mindspore.nn.BatchNorm2d(features)
            self.bn2 = mindspore.nn.BatchNorm2d(features)
...
class FeatureFusionBlock_custom(mindspore.nn.cell):
    """Feature fusion block."""
    ...
    def __init__(
        ...
        #     groups=1,
        # )
        self.out_conv = mindspore.nn.Conv2d(
            features,
            out_features,
            kernel_size=1,
            stride=1,
